...
adapter =ConnectionPool.add_data_source :type => :sparql,:engine => :sesame2, :url => "http://localhost:8087/openrdf-sesame/repositories/MONDIAL", :results => :sparql_xml, :caching =>true
